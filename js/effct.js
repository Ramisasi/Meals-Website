        ...
        $("#LeftBoxTopUl a").click((e) => {
            ...
            if (listName == "Search") {
                ...
                <div class="input-group flex-nowrap mt-5">
                    ...
                    <input type="text" id="searchByletter" class="ms-2 text-center text-light border-0 border-bottom bg-transparent rounded form-control" placeholder="Server" aria-label="Server">
             </div>`
